...
FITBIT_USERNAME="wearables@massmutual.com"
...
def remove_fitbit_connection(connection_expected=False):
    ...
    # if we see one called "LivingWELL by MassMutual Dev"
    ...
    with sync_playwright() as p:
        ...
        # in python
        page.click("button:has-text('Sign in')")
        # Check for the "LivingWELL by MassMutual Dev" app with a timeout of 5 seconds
        app_available = False
        try:
            app_selector = "li:has-text('LivingWELL by MassMutual Dev')"
        ...
        if app_available:
            ...
            # li = page.query_selector("li:has-text('LivingWELL by MassMutual Dev')")
